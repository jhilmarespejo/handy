...
<p>
FECHA Y HORA:
	<b><?php echo $consideraciones[0]['fecha_hora']->i18nFormat('yyyy-MM-dd HH:mm:ss');?> </b>
</p>
		...
		<tbody>
			<?php foreach($datosnino as $datonino ){ ?>
				<tr>
					...
					<td><?php echo $datonino['fecha_nacimiento']->i18nFormat('yyyy-MM-dd'); ?></td>
