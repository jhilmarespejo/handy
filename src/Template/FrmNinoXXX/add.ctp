	...
	<div class="group1 col-xs-12 col-sm-6 col-md-6 col-lg-6">
		...
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('datosnino.id_nino', ['label' => ['text' => 'Código del niña(o)'], 'class'=>'form-control', 'type'=>'text', 'required', 'value' => $nino[0]['id_nino']] );  ?>
			</div>
		
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('datosnino.paterno', ['label' => ['text' => 'Apellido Paterno'], 'class'=>'form-control', 'type'=>'text', 'value' => $nino[0]['paterno']] ); ?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('datosnino.materno', ['label' => ['text' => 'Apellido Materno'], 'class'=>'form-control', 'type'=>'text', 'required', 'value' => $nino[0]['materno']] );?>
			</div>

			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('datosnino.nombres', ['label' => ['text' => 'Nombres'], 'class'=>'form-control', 'type'=>'text', 'required', 'value' => $nino[0]['nombres'] ] );?>
			</div>

			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">			
				<?php echo $this->Form->input('datosnino.fecha_nacimiento', ['label' => ['text' => 'Fecha de nacimiento'], 'class'=>'form-control', 'type'=>'text', 'required', 'value' =>  ($nino[0]['fecha_nacimiento'])? $nino[0]['fecha_nacimiento']->i18nFormat('yyyy-MM-dd'):'']  );  ?>
			</div>
...
<!--
	...
	<div class="group2 col-xs-12 col-sm-6 col-md-6 col-lg-6">
		...
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('aspectoseconomicos.monto_adeudado', ['label' => ['text' => 'Monto adeudado (en bolivianos)'], 'class'=>'form-control', 'type' => 'number', 'min' => '0', 'value' => '0' ] );
				?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
