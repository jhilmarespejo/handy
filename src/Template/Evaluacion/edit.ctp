...
<h3 class="title2 text-center"> Edición de datos</h3>

<?php echo $this->Form->create($datosEv); ?>
<div class="board col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<div class="group1 col-xs-12 col-sm-6 col-md-6 col-lg-6 animated fadeInUp">
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('fecha_nacimiento', ['label' => ['text' => 'Fecha de nacimiento'], 'class'=>'form-control', 'type' => 'text', 'required', 'value' => $datosEv->fecha_nacimiento->i18nFormat('yyyy-MM-dd')] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<?php 
					$phones = json_decode($datosEv->telf,true);
					//pr($phones);
				?>
				<label class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">Números de contacto</label>
				<div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<?php echo '1. '.$this->Form->input('telf.0', ['label' => false, 'class'=>'form-control', 'type' => 'number', 'min'=>'0', 'required', 'value' => $phones[0]] );?>
				</div>
				<div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<?php echo '2. '.$this->Form->input('telf.1', ['label' => false, 'class'=>'form-control', 'type' => 'number', 'min'=>'0', 'value' => $phones[1]] );?>
				</div>
				<div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<?php echo '3. '.$this->Form->input('telf.2', ['label' => false, 'class'=>'form-control', 'type' => 'number', 'min'=>'0', 'value' => $phones[2]] );?>
				</div>
		...
		<fieldset>
			...
			<!-- Para educadoras -->
			<?php if($datosEv->cargo == 'Educadora') {	 ?>

			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6" id='educadoras'>
 ...
 -->
	...
	<div class="group2 col-xs-12 col-sm-6 col-md-6 col-lg-6 animated fadeInDown">
		...
		<fieldset>
			...
			<?php $cims = json_decode($datosEv->cim_postulacion,true); 
				//pr($cims);
			?>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('cim_postulacion.0', ['label' =>['text'=>' 1.'], 'class'=>'form-control', 'type' => 'text', 'value' => $cims[0], 'required' ] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('cim_postulacion.1', ['label' =>['text'=>' 2.'], 'class'=>'form-control', 'type' => 'text', 'value' => $cims[1]] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('cim_postulacion.2', ['label' =>['text'=>' 3.'], 'class'=>'form-control', 'type' => 'text', 'value' => $cims[2]] );?>
			</div>
		</fieldset>
		<fieldset>
