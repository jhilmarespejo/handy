<?//php pr($cims); ?>
<!--<div class="text-left">
	<?//php echo $this->Html->link( $this->Html->tag('i', '&nbsp;', ['class' => 'fa fa-reply']).' Nuevo registro ', ['controller' => 'Cim', 'action' => 'index'], array('escape'=>false, 'class' => 'alert-warning') ); ?>&nbsp;&nbsp;&nbsp;
	<?//php echo $this->Html->link( $this->Html->tag('i', '&nbsp;', ['class' => 'fa fa-bank']).' Reportes ', ['controller' => 'Cim','action' => 'reports'], array('escape'=>false, 'class' => 'alert-warning') ); ?>
</div><hr>-->

<h3 class="title2 text-center"> Registro de Centro Infantil </h3>

<div class="board col-xs-12 col-sm-12 col-md-12 col-lg-12">
<?php echo $this->Form->create($cims , ['url' => ['action' => 'add'], 'id' => 'frm-add-cim' ]); ?>
	<div class="group1 col-xs-12 col-sm-6 col-md-6 col-lg-6 animated fadeInDown">
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('id_cim', ['label' => ['text' => 'Código del Centro Infantil'], 'class'=>'form-control', 'type' => 'text', 'required'] );?>
			</div>	
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('fecha_inauguracion', ['minYear' => 1990,'maxYear' => date('Y'), 'label' => ['text' => 'Fecha de inauguración'], 'class'=>'form-control', 'type' => 'date'] );
				?>
			</div>
		</fieldset>
		<br>
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('distrito', ['label' => ['text' => 'Distrito'], 'class'=>'form-control', 'type' => 'number', 'min' => '0', 'max'=>'14'] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('numero', ['label' => ['text' => 'Número'], 'class'=>'form-control', 'type' => 'number', 'min' => '0'] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('telf', ['label' => ['text' => 'Teléfono'], 'class'=>'form-control', 'type' => 'number', 'min' => '0'] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('email', ['label' => ['text' => 'E-mail'], 'class'=>'form-control', 'type' => 'email'] );?>
			</div>
		</fieldset>
		<br>
		<fieldset>
	...
	<div class="group2 col-xs-12 col-sm-6 col-md-6 col-lg-6 animated fadeInUp">
		...
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6"><?php
				echo $this->Form->input('aulas_detalle', ['label' => ['text' => 'Especifique'], 'class'=>'form-control col-xs-12 col-sm-6 col-md-6 col-lg-6', 'type' => 'text', 'maxlength' => '140'] );?>
			</div>
		...
		<fieldset>
			...
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<?php echo $this->Form->input('fecha_cierre', ['label' => ['text' => 'Fecha de cierre'], 'class'=>'form-control', 'type' => 'text'] );?>
			</div>
			<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
...
almacen,
comedor,
sala_psicomotricidad,
otro_ambiente,
aulas_independientes,
cantidad_aulas,
aulas_detalle,
agua,
agua_detalle,
electricidad,
electricidad_detalle,
alcantarillado,
alcantarillado_detalle,
gas,
gas_detalle,
