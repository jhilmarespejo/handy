...
<br>
<h2 class="title2 text-center"> Registro de Personal </h2>


<div class="board col-xs-12 col-sm-12 col-md-12 col-lg-12">
<!-- <?//php $options = [[ 'text' => '', 'value' => '', 'selected', 'disabled'],[ 'text' => '', 'value' => '']];	echo $this->Form->select('nino_vive_con', $options, ['class'=>'form-control', 'id'=>'nino-vive-con']);?> -->


<?php echo $this->Form->create($personal , ['url' => ['action' => 'add'], 'id' => 'frm-add-cim' ]); ?>
